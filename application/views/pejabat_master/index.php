											...
											<thead> 
												...
												<?php foreach ($pejabat as $pej) : ?>
													<tr>
														...
														<td><?php echo $pej->jenis_kelamin; ?></td>
														<td><?php echo $pej->alamat; ?></td>
														<td><?php echo $pej->master_pejabat_name; ?></td>
														<td><?php echo $pej->tglBuat; ?></td>
														<td><?php echo $pej->tglUbah; ?></td>
														<td>
															<a href="<?php echo base_url('pejabat/edit/'.$pej->id); ?>" style="display: inline-block; background-color: #007bff; color: #fff; padding: 7px 10px; text-decoration: none; border-radius: 5px;">Edit</a>
															<a href="<?php echo base_url('pejabat/delete/'.$pej->id); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" style="display: inline-block; background-color: #FF0000; color: #fff; padding: 7px 10px; text-decoration: none; border-radius: 5px;">Hapus</a>
														</td>
													</tr>
												<?php endforeach; ?>
											</thead>
